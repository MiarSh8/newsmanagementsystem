...
//لقد استعنت قليلاً ب الذكاء الاصطناعي بهذه الجزئية
<!DOCTYPE html>
                ...
                <div class="card">
                    ...
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" name="content" class="form-control" rows="10" required><?php echo isset($content) ? $content : ''; ?></textarea>
                        </div>
                        ...
                        <button type="submit" name="add_news" class="btn">إضافة الخبر</button>
                        <a href="view_news.php" class="btn" style="background: #7f8c8d;">عرض الأخبار</a>
                    </form>
                </div>
            </main>
        </div>
